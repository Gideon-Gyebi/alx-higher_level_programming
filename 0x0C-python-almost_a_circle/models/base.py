...
class Base:
    ...
    def save_to_file(cls, list_objs):
        ...
        Args:
            list_objs (list): Is a list of inherited Base instances.
        """
    ...
    def from_json_string(json_string):
        ...
        Args:
            json_string (str): Is a JSON str representation of a list of dicts.
        Returns:
    ...
    def create(cls, **dictionary):
        ...
        Args:
            **dictionary (dict): Is the key/value pairs of attributes to initialize.
        """
    ...
    def draw(list_rectangles, list_squares):
        ...
        Args:
            list_rectangles (list): Is a list of Rectangle objects to draw.
            list_squares (list): Is a list of Square objects to draw.
        """
        turt = turtle.Turtle()
