...
Attributes:
    board (list): Is a list of lists representing the chessboard.
    solutions (list): Is a list of lists containing solutions.
...
def init_board(n):
    """Initializing an `n`x`n` sized chessboard with 0."""
    board = []
...
def xout(board, row, col):
    ...
    longer be played are cancelled (X-ed) out.
