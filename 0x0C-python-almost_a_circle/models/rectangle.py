...
class Rectangle(Base):
    ...
    def __init__(self, width, height, x=0, y=0, id=None):
        ...
        Args:
            ...
            x (int): Is the x coordinate of the new Rectangle.
            y (int): Is the y coordinate of the new Rectangle.
            id (int): Is the identity of the new Rectangle.
        Raises:
    ...
    def update(self, *args, **kwargs):
        ...
        Args:
            ...
            **kwargs (dict): Is the new key/value pairs of attributes.
        """
