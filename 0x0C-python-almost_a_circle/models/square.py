...
class Square(Rectangle):
    ...
    def __init__(self, size, x=0, y=0, id=None):
        ...
        Args:
            ...
            x (int): Is the x coordinate of the new Square.
            y (int): Is the y coordinate of the new Square.
            id (int): Is the identity of the new Square.
        """
    ...
    def update(self, *args, **kwargs):
        ...
        Args:
            *args (ints): Is a new attribute values.
