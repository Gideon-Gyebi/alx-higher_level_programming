...
class Rectangle:
    ...
    Attributes:
        ...
        print_symbol (any): Is the symbol used for string representation.
    """
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Returnng the Rectangle with the greater area.
    ...
    def square(cls, size=0):
        ...
        Args:
            size (int): Is the width and height of the new Rectangle.
        """
